...
function [perfs1,N1] = mse_1mask(t,y,en,ew,mask1)
e = (t-y).*en;
perfs1 = (e.^2).*ew.*mask1;
isNaN = isnan(perfs1);
if isNaN
...
function [perfs1,perfs2,perfs3,N1,N2,N3] = mse_3masks(t,y,en,ew,mask1,mask2,mask3)
e = (t-y).*en;
perfs = (e.^2)*ew;
perfs1 = perfs .* mask1;
isNaN = isnan(perfs1);
...
function [perfs1,N1,dy] = mse_dy_1mask(t,y,en,ew,mask1)
e = (t-y).*en;
perfs1 = (e.^2).*ew.*mask1;
isNaN = isnan(perfs1);
if isNaN
...
function [perfs1,perfs2,perfs3,N1,N2,N3,dy] = mse_dy_3masks(t,y,en,ew,mask1,mask2,mask3)
e = (t-y).*en;
perfs = (e.^2)*ew;
perfs1 = perfs .* mask1;
isNaN = isnan(perfs1);
...
function [perfs1,N1] = mae_1mask(t,y,en,ew,mask1)
e = (t-y).*en;
...
function [perfs1,perfs2,perfs3,N1,N2,N3] = mae_3masks(t,y,en,ew,mask1,mask2,mask3)
e = (t-y).*en;
perfs = abs(e)*ew;
perfs1 = perfs .* mask1;
isNaN = isnan(perfs1);
...
function [perfs1,N1,dy] = mae_dy_1mask(t,y,en,ew,mask1)
e = (t-y).*en;
perfs1 = abs(e).*ew.*mask1;
isNaN = isnan(perfs1);
if isNaN
...
function [perfs1,perfs2,perfs3,N1,N2,N3,dy] = mae_dy_3masks(t,y,en,ew,mask1,mask2,mask3)
e = (t-y).*en;
perfs = abs(e)*ew;
perfs1 = perfs .* mask1;
isNaN = isnan(perfs1);
...
function [perfs1,N1] = crossentropy_1mask(t,y,en,ew,mask1)
if (y<0), y = 0; elseif (y>1), y = 1; end
if (t<0), t = 0; elseif (t>1), t = 1; end
perfs1 = (-t.*log(max(y,eps))).*ew.*mask1;
isNaN = isnan(perfs1);
if isNaN
    perfs1 = 0;
    N1 = 0;
...
function [perfs1,perfs2,perfs3,N1,N2,N3] = crossentropy_3masks(t,y,en,ew,mask1,mask2,mask3)
if (y<0), y = 0; elseif (y>1), y = 1; end
if (t<0), t = 0; elseif (t>1), t = 1; end
perfs = (-t.*log(max(y,eps))).*ew;
perfs1 = perfs .* mask1;
isNaN = isnan(perfs1);
if isNaN
    perfs1 = 0;
...
function [perfs1,N1,dy] = crossentropy_dy_1mask(t,y,en,ew,mask1)
if (y<0), y = 0; elseif (y>1), y = 1; end
if (t<0), t = 0; elseif (t>1), t = 1; end
perfs1 = (-t.*log(max(y,eps))).*ew.*mask1;
isNaN = isnan(perfs1);
...
function [perfs1,perfs2,perfs3,N1,N2,N3,dy] = crossentropy_dy_3masks(t,y,en,ew,mask1,mask2,mask3)
if (y<0), y = 0; elseif (y>1), y = 1; end
if (t<0), t = 0; elseif (t>1), t = 1; end
perfs = -(t.*log(max(y,eps)) + (1-t).*log(max(1-y,eps)))*ew;
perfs1 = perfs .* mask1;
isNaN = isnan(perfs1);
if isNaN
    perfs1 = 0;
...
function [perfs1,N1] = msesparse_1mask(t,y,en,ew,mask1)
e = (t-y).*en;
perfs1 = (e.^2).*ew.*mask1;
isNaN = isnan(perfs1);
if isNaN
...
function [perfs1,perfs2,perfs3,N1,N2,N3] = msesparse_3masks(t,y,en,ew,mask1,mask2,mask3)
e = (t-y).*en;
perfs = (e.^2)*ew;
perfs1 = perfs .* mask1;
isNaN = isnan(perfs1);
...
function [perfs1,N1,dy] = msesparse_dy_1mask(t,y,en,ew,mask1)
e = (t-y).*en;
perfs1 = (e.^2).*ew.*mask1;
isNaN = isnan(perfs1);
if isNaN
...
function [perfs1,perfs2,perfs3,N1,N2,N3,dy] = msesparse_dy_3masks(t,y,en,ew,mask1,mask2,mask3)
e = (t-y).*en;
perfs = (e.^2)*ew;
perfs1 = perfs .* mask1;
isNaN = isnan(perfs1);
