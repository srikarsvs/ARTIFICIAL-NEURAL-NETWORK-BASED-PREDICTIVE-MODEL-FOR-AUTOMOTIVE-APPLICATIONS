...
for ts = TS:-1:1
  for i = fliplr(hints.layerOrder)
    ...
    if net.outputConnect(i)
      ...
      mask1 = masks{1}{ii,ts};
      if (numMasks == 1)
        [perfs1,N1,dy] = arrayfun(hints.performFcns.perf_dy_1mask,ti,yi,en,ew,mask1);
      else
        mask2 = masks{2}{ii,ts};
        mask3 = masks{3}{ii,ts};
        [perfs1,perfs2,perfs3,N1,N2,N3,dy] = arrayfun(hints.performFcns.perf_dy_3masks,ti,yi,en,ew,mask1,mask2,mask3);
